...
define('G5_TOKEN_ENCRYPTION_KEY', '1157bcb4b421040611650c4da3f9c8f8'); // 토큰 암호화에 사용할 키
...
$g5['crm_landing_sms'] = G5_TABLE_PREFIX.'crm_landing_sms'; // CRM:crm_landing_sms

$g5['crm_landing_bk'] = G5_TABLE_PREFIX.'crm_landing_bk'; // CRM:랜딩백업


$g5['crm_api_auth'] = G5_TABLE_PREFIX.'crm_api_auth'; // CRM:api권한
$g5['crm_api_resv'] = G5_TABLE_PREFIX.'crm_api_resv'; // CRM:api 받기
$g5['crm_api_send'] = G5_TABLE_PREFIX.'crm_api_send'; // CRM:api 보내기

$g5['comm_domain'] = G5_TABLE_PREFIX.'comm_domain'; // common: domain 부서별 관리
